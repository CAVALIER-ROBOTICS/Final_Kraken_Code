...
public interface DriveTrainConstants {
  ...
  public static final double frontLeftModuleSteerOffset = Math.toRadians(90); // FIXME Measure and set front left
                                                                             // steer offset
  ...
  public static final double frontRightModuleSteerOffset = Math.toRadians(45); // FIXME Measure and set front right
  // steer offset
