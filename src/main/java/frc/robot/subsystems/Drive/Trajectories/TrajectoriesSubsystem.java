...
package frc.robot.subsystems.Drive.Trajectories;

import com.pathplanner.lib.server.PathPlannerServer;
import edu.wpi.first.math.controller.PIDController;
import edu.wpi.first.math.geometry.Rotation2d;
import edu.wpi.first.wpilibj2.command.SubsystemBase;
import frc.robot.swerve.TorqueSwerveSpeeds;

import java.util.function.DoubleSupplier;

public class TrajectoriesSubsystem extends SubsystemBase {
    public TorqueSwerveSpeeds speeds;
    ...
    public double calculteTheta(double goalAngleRadians) {
        return thetaController.calculate(speeds.getHeading().getRadians(), goalAngleRadians);
    }
